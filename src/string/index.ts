...
@NgModule({
  declarations: [
    EndsWithPipe,  StartsWithPipe, LatinizePipe,
    LeftTrimPipe,  TrimPipe,       RightTrimPipe,
    MatchPipe,     TestPipe,       RepeatPipe,
    SlugifyPipe,   SplitPipe,      StringularPipe,
    StripTagsPipe, TruncatePipe,   UcfirstPipe,
    TitleizePipe,  UriEncodePipe,  UriComponentEncodePipe,
    WrapPipe,
  ],
  exports: [
    EndsWithPipe,  LatinizePipe,  StartsWithPipe,
    LeftTrimPipe,  RightTrimPipe, TrimPipe,
    MatchPipe,     TestPipe,      RepeatPipe,
    SlugifyPipe,   SplitPipe,     StringularPipe,
    StripTagsPipe, TruncatePipe,  UcfirstPipe,
    TitleizePipe,  UriEncodePipe, UriComponentEncodePipe,
